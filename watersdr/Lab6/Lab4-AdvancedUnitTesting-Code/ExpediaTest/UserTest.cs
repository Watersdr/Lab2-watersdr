...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        public void TestThatUserDoesRemoveCarFromServiceLocatorWhenBooked()
        {
            ...
            Assert.AreEqual(ServiceLocator.Instance.AvailableCars[0], remainingCar);
        }
        ...
        public void TestThatUserDoesRemoveFlightFromServiceLocatorWhenBooked()
        {
            ...
            var remainingFlight = new Flight(StartDate, EndDate, 200);
            ...
            Assert.AreEqual(ServiceLocator.Instance.AvailableFlights[0], remainingFlight);
        }
